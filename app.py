...
def display_about_us():
    ...
    st.markdown("Our AI agent relies exclusively on information retrieved from the following official sources to ensure accuracy and reliability:")
...
def display_methodology():
    ...
    steps = [
        ...
        ("🔢", "Embedding Generation", "Each chunk is converted into numerical vectors using OpenAI embeddings", "#fff3e0"),
        ("💾", "Vector Indexing", "Embeddings are stored in FAISS vector store for efficient similarity searches", "#f3e5f5"),
        ("🔍", "Retrieval", "User queries are matched against stored embeddings to find relevant content", "#fce4ec"),
        ("✨", "Answer Generation", "LLM generates responses based ONLY on retrieved context, reducing hallucinations", "#e8f5e8")
    ]
    ...
    safeguards = [
        ...
        ("🔧", "Tool-Based Agents", "Capabilities are structured into specific tools with predefined actions", "#fff3e0"),
